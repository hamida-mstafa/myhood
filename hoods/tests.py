...
class UserTest(TestCase):
    def setUp(self):
        self.user=User(username='hams',first_name='h',last_name='m',email='hamidamstafa@gmail.com')

    def test_instance(self):
        self.assertTrue(isinstance(self.user,User))

    def test_data(self):
        self.assertTrue(self.user.username,"hams")
        self.assertTrue(self.user.first_name,"h")
        self.assertTrue(self.user.last_name,'m')
        self.assertTrue(self.user.email,'hams@gmail.com')
...
class NeighbourhoodTest(TestCase):
    def setUp(self):
        self.user=User(username='ham',first_name='h',last_name='m',email='hams@gmail.com')
        self.user.save()
        self.admin=User(username='msc',first_name='m',last_name='s',email='msc@gmail.com')
        self.admin.save()
        self.hood = Neighbourhoods(user=self.user,admin=self.admin,name='ruiru',location='nyairofi')

    def test_instance(self):
        self.assertTrue(isinstance( self.hood,Neighbourhoods))

    def test_data(self):
        self.assertTrue(self.hood.name,"ruiru")
...
class postsTest(TestCase):
    def setUp(self):
        self.user=User(username='hams',first_name='d',last_name='k',email='hams@gmail.com')
        self.user.save()
        self.admin=User(username='kd',first_name='d',last_name='k',email='hams@gmail.com')
        self.admin.save()
